...
SEO_CATEGORIES = {
    ...
    # Nouveaux thèmes SEO longue traîne (issus des accordéons "Type de spectacle recherché")
    "conte": "conte",
    "conteur": "conte",
    ...
    "pere-noel": "père noël",
    "echassier": "échassier",
    "sculpteur-ballons": "ballons",
    "caricaturiste": "caricatur",
    "maquillage": "maquillage",
    "one-man-show": "one-man",
    "comedie-musicale": "comédie musicale",
    "chorale-gospel": "chorale",
    "fanfare": "fanfare",
    "dj-orchestre": "d.j.",
    "jazz": "jazz",
    "musique-classique": "musique classique",
    "chanson-francaise": "chanson française",
    "spectacle-medieval": "médiéval",
    "spectacle-animalier": "animalier",
    "cabaret": "cabaret",
}
